...
The image planner considers optimal trajectories in a short term horizon within in the image space, removing the reliance on local planning with a cost map.
